...
custlist = cf.data_load('PythonData\python_basic\01_basic\item.json')
...
while True:
    ...
    if choice=="I":  
       page = cf.customer_input(custlist)

    elif choice=="C": 
       cf.cur_page(custlist, page)

    elif choice == 'P':
        page = cf.pre_page(custlist)

    elif choice == 'N':
        page = cf.next_page(custlist)
        ...
        cf.data_save('PythonData\python_basic\01_basic\custlist.json', custlist)
        break
